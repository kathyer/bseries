<?php
	...
	if ($_POST)
	{
		votarHumor($_SESSION["usuario"]["id"], $_POST["id_comentario"], $_POST["tipoVoto"]);
		actualizarVotosHumor($_POST["id_comentario"]);
		$comentario = obtenerVotosPorIdYVotoDeUsuario($_POST["id_comentario"], $_SESSION["usuario"]["id"]);
